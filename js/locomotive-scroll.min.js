                ...
                (this.els = {}),
                  this.el
                    ...
                    .forEach(function (e, i) {
                      ...
                      (t.els[o] = p),
                        e.classList.contains(n) && t.setInView(t.els[o], o);
                    });
              },
            },
            {
              ...
              (this.els = {}),
                ...
                this.el
                  ...
                  .forEach(function (e, i) {
                    ...
                    null === r || r.inView
                      ? ((s = g.top + t.instance.scroll.y - q(o).y),
                        (n = g.left + t.instance.scroll.x - q(o).x))
                      : ((s = g.top - q(r.el).y - q(o).y),
                        (n = g.left - q(r.el).x - q(o).x));
            ...
            value: function (t) {
              ...
              var y = parseFloat(this.instance.delta[this.directionAxis]),
                ...
                g = function (t) {
                  l
                    ? "horizontal" === e.direction
                      ? e.setScroll(y + w * t, e.instance.delta.y)
                      : e.setScroll(e.instance.delta.x, y + w * t)
                    : (e.instance.delta[e.directionAxis] = y + w * t);
                };
                ...
                S = function t() {
                  ...
                  i > 1
                    ? (g(1),
                      ...
                      0 == n && e.update(),
                      r && r())
                    : ((e.scrollToRaf = requestAnimationFrame(t)), g(o(i)));
                };
              S();
            },
          },
